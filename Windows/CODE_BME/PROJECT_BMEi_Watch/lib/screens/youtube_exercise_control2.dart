...
final List<YoutubeVideo> youtubeVideos = [
  YoutubeVideo(title: 'Basic', TH_title: 'ระดับเบา',
      links: [
        'https://www.youtube.com/watch?v=-lmjJMEelAs',],
      events: ['การออกกำลังกายแอโรบิก ระดับเบา',]),
  YoutubeVideo(title: 'Intermediate', TH_title: 'ระดับปานกลาง',
      links: [
        'https://www.youtube.com/watch?v=AdqrTg_hpEQ',],
      events: ['การออกกำลังกายแอโรบิก ระดับปานกลาง',]),
  YoutubeVideo(title: 'Advance', TH_title: 'ระดับหนัก',
      links: [
        'https://www.youtube.com/watch?v=4bGXW8vuZvM',],
      events: ['การออกกำลังกายแอโรบิก ระดับหนัก']),
];

class YoutubeControlList2 extends StatefulWidget {
  const YoutubeControlList2({super.key});

  @override
  _YoutubeControlListState createState() => _YoutubeControlListState();
}

class _YoutubeControlListState extends State<YoutubeControlList2> {
  @override
  void initState() {
    super.initState();
