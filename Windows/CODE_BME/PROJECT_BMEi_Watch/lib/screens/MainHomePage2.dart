...
import 'dart:convert';
import 'YoutubeExercisePage.dart';
...
class MainHomePage2 extends StatefulWidget {
  const MainHomePage2({super.key, required this.title});
  final String title;
...
class _MainHomePage2State extends State<MainHomePage2> {
  ...
  void refreshPage() {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const MainHomePage2(title: "หน้าหลัก")),
    );
  }
              ...
              GestureDetector(
                onTap: () {
                  if(index == 0 || index == 1){
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => YoutubeExercisePage()),
                    );
                  }else{
                    // Navigator.push(
                    //   context,
