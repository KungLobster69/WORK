...
% GK Clustering สำหรับ ABNORMAL
disp('Processing ABNORMAL Dataset...');
[U_ABNORMAL, V_ABNORMAL, clusterLabels_ABNORMAL] = ...
    GKClustering(ABNORMAL, percentClusters_ABNORMAL, m, maxIter, epsilon);
...
title('ABNORMAL Dataset (GK Clustering)');
xlabel('Feature 1');
ylabel('Feature 2');
zlabel('Feature 3');
grid on;

% GK Clustering สำหรับ INTERMEDIATE
disp('Processing INTERMEDIATE Dataset...');
[U_INTERMEDIATE, V_INTERMEDIATE, clusterLabels_INTERMEDIATE] = ...
    GKClustering(INTERMEDIATE, percentClusters_INTERMEDIATE, m, maxIter, epsilon);
...
title('INTERMEDIATE Dataset (GK Clustering)');
xlabel('Feature 1');
ylabel('Feature 2');
zlabel('Feature 3');
grid on;

% GK Clustering สำหรับ NORMAL
disp('Processing NORMAL Dataset...');
[U_NORMAL, V_NORMAL, clusterLabels_NORMAL] = ...
    GKClustering(NORMAL, percentClusters_NORMAL, m, maxIter, epsilon);
...
title('NORMAL Dataset (GK Clustering)');
xlabel('Feature 1');
ylabel('Feature 2');
zlabel('Feature 3');
grid on;